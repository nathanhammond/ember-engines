  ...
  extend: function(options) {
    ...
    options.init = function() {
      ...
      this.included = function() {
        ...
        originalIncluded.apply(this, arguments);
      ...
      this.treeForAddon = function(engineSourceTree) {
        ...
        return mergeTrees([childAppTreeRelocated, engineBigHappyFamily, configTree], { overwrite: true });
      };
    ...
    */
    options.treeFor = function treeFor(name, source) {
      ...
      if (name === 'addon' && source !== 'buildVendorTree') {
        trees = this.eachAddonInvoke('treeForEngine', [this]);
