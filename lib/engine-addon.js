...
module.exports = {
  extend: function(options) {
    ...
    options.init = function() {
      ...
      // TEMPORARY: throw when a user specifies `lazyLoading: true` before we support it.
      if (this.lazyLoading === true) {
        throw new Error('Lazy loading engines is unsupported.');
      }
      ...
      this.treeForAddon = function() {
        ...
        return new Funnel(engineJSTree, {
      ...
      this.treeForPublic = function() {
        ...
        var transpiledEngineTree = babelTranspiler(engineJSTreeRelocated, babelOptions);
