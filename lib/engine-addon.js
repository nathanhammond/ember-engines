...
function buildExternalTree() {
  return new Funnel(path.join(this.root, 'vendor'), {
    destDir: 'vendor'
  });
}
...
module.exports = {
  extend: function(options) {
    ...
    options.init = function() {
      ...
      var originalFindHost = this._findHost;
      ...
      this.import = function() {
        ...
        this._import = host._import;
        this._getAssetPath = host._getAssetPath;
        this.otherAssets = host.otherAssets;

        return host.import.apply(target, arguments);
      }
      ...
      this.included = function() {
        ...
        if (this.lazyLoading === true) {
          ...
          host.import('engines-dist/' + this.name + '/assets/engine-vendor.js');
          host.import('engines-dist/' + this.name + '/assets/engine-vendor.css');
        }

        return originalIncluded.apply(host, arguments);
      }
      ...
      this.treeForPublic = function() {
        ...
        var vendorJSImportTree = buildVendorJSWithImports.call(this, concatTranspiledVendorJSTree);
        ...
        // So, this is weird, but imports are processed in order.
        // This gives the chance for somebody to prepend onto the vendor files.
        var vendorCSSImportTree = buildVendorCSSWithImports.call(this, concatVendorCSSTree);
